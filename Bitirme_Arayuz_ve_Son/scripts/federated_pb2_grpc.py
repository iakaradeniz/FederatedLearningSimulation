...
class FederatedLearningStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendWeights = channel.unary_unary(
                '/federated.FederatedLearning/SendWeights',
                request_serializer=federated__pb2.WeightsRequest.SerializeToString,
                response_deserializer=federated__pb2.GlobalModelResponse.FromString,
...
def add_FederatedLearningServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendWeights': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=federated__pb2.WeightsRequest.FromString,
                    response_serializer=federated__pb2.GlobalModelResponse.SerializeToString,
            ),
...
class FederatedLearning(object):
    ...
    def SendWeights(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/federated.FederatedLearning/SendWeights',
            federated__pb2.WeightsRequest.SerializeToString,
            federated__pb2.GlobalModelResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
